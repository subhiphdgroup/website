    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
          <!-- logo start -->
          <div class="logo"> <a href="it_home.html"><img src="images/logo.png" alt="logo" /></a> </div>
          <!-- logo end -->
        </div>
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li><a href="it_about.html">Courses</a></li>
                <li> <a href="it_service.html">Solutions</a></li>
            
                <li> <a href="it_shop.html">Marketing</a></li>
                <li> <a href="it_contact.html">Software</a></li>
              </ul>
            </div>
